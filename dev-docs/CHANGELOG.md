...
- Support `fromCell()` and `fromSlice()` methods on contract types: PR [#3303](https://github.com/tact-lang/tact/pull/3303), PR [#3305](https://github.com/tact-lang/tact/pull/3305)
