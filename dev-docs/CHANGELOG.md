...
- Ensured that variables are always shown declared with immediate initialization, and made it clear in the descriptions of the `let` statement: PR [#TBD](https://github.com/tact-lang/tact/pull/TBD)
