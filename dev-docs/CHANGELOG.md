...
- [fix] The parser does not throw an internal compiler error if there is the closing brace for the function body is missing: PR [#2485](https://github.com/tact-lang/tact/pull/2485)
