...
- Added `internalExternalReceiversOutsideMethodsMap` config option as part of optimization options to protect potentially unwanted optimization: PR [#1660](https://github.com/tact-lang/tact/pull/1660)
