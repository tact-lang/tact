...
export const AliasSig = (
    typeParams: $.TypeParams,
    type_: Thunk<$d.DecodedType>,
): $.AliasSig =>
    Object.freeze({
        kind: "alias",
        typeParams,
...
export const DecodedFnType = (
    typeParams: $.TypeParams,
    params: $.Parameters,
    returnType: Thunk<$d.DecodedType>,
): $.DecodedFnType =>
    Object.freeze({
        kind: "DecodedFnType",
        typeParams,
...
export const BounceSig = (
    message: readonly DeclMem<MessageRecv>[],
...
export const StructSig = (
    typeParams: $.TypeParams,
    fields: $.Ordered<$.InhFieldSig>,
): $.StructSig =>
    Object.freeze({
        kind: "struct",
        typeParams,
...
export const UnionSig = (
    typeParams: $.TypeParams,
    cases: ReadonlyMap<string, ReadonlyMap<string, InhFieldSig>>,
): $.UnionSig =>
    Object.freeze({
        kind: "union",
        typeParams,
...
export const Scope = (
    typeDecls: ReadonlyMap<string, $.Decl<$.TypeDeclSig>>,
    fnSigs: ReadonlyMap<string, $.Decl<$.FnSig>>,
    constSigs: ReadonlyMap<string, $.Decl<$.ConstSig>>,
    extSigs: ReadonlyMap<string, Thunk<readonly $.Decl<$.ExtSig>[]>>,
): $.Scope =>
    Object.freeze({
        typeDecls,
        functions: fnSigs,
...
export const DecodedMethodType = (
    mutates: boolean,
    typeParams: $.TypeParams,
    self: $m.SelfType,
    params: $.Parameters,
...
export const TactBody = (
    statements: Thunk<StatementsAux | undefined>,
): $.TactBody =>
    Object.freeze({
        kind: "tact",
        statements,
...
export const FuncBody = (nativeName: $c.FuncId): $.FuncBody =>
    Object.freeze({
        kind: "func",
        nativeName,
    });
...
export const FieldConstSig = <Expr>(
    overridable: boolean,
    type_: Thunk<$d.DecodedType>,
    init: Expr,
): $.FieldConstSig<Expr> =>
...
export const isFieldConstSig = <Expr>($value: FieldConstSig<Expr>) =>
    $value.kind === "constant";
export type Fieldish<Expr> = $.Fieldish<Expr>;
export type MethodSig<Body> = $.MethodSig<Body>;
export const MethodSig = <Body>(
    overridable: boolean,
    type_: $.DecodedMethodType,
    inline: boolean,
    body: Body,
...
export const CommonSig = <Expr, Body>(
    fieldish: $.Ordered<$.DeclMem<$.Fieldish<Expr>>>,
    methods: ReadonlyMap<string, $.DeclMem<$.MethodSig<Body>>>,
    receivers: $.Receivers,
): $.CommonSig<Expr, Body> =>
    Object.freeze({
        fieldish,
...
export const TraitSig = (
    content: Thunk<
        $.CommonSig<Thunk<Value | undefined> | undefined, $.Body | undefined>
    >,
): $.TraitSig =>
    Object.freeze({
        kind: "trait",
...
export const MessageRecv = (
    name: $c.OptionalId,
    type_: $d.DTypeRef | $d.DTypeBounced,
    statements: Thunk<undefined | StatementsAux>,
): $.MessageRecv =>
    Object.freeze({
        kind: "binary",
        name,
...
export const RecvSig = (
    message: readonly DeclMem<OpcodeRecv>[],
    messageAny: $.DeclMem<$.MessageAnyRecv> | undefined,
...
export const InitSimple = (
    fill: $.Ordered<$.InitParam>,
    loc: $c.Loc,
): $.InitSimple =>
    Object.freeze({
        kind: "simple",
...
export const ContractSig = (
    attributes: readonly ContractAttribute[],
    init: $.InitSig,
    content: Thunk<$.ContractContent>,
): $.ContractSig =>
    Object.freeze({
        kind: "contract",
        attributes,
...
export const isContractSig = ($value: ContractSig) =>
    $value.kind === "contract";
