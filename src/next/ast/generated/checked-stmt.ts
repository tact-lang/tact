...
export const isDStatementLet = ($value: DStatementLet) =>
    $value.kind === "statement_let";
export type DStatementReturn = $.DStatementReturn;
export const DStatementReturn = (
    expression: $e.DecodedExpression | undefined,
    loc: $c.Loc,
): $.DStatementReturn =>
    Object.freeze({
...
export const isDStatementReturn = ($value: DStatementReturn) =>
    $value.kind === "statement_return";
export type DStatementExpression = $.DStatementExpression;
export const DStatementExpression = (
    expression: $e.DecodedExpression,
    loc: $c.Loc,
...
export const isDStatementExpression = ($value: DStatementExpression) =>
    $value.kind === "statement_expression";
export type DStatementAssign = $.DStatementAssign;
export const DStatementAssign = (
    path: $e.LValue,
    expression: $e.DecodedExpression,
    loc: $c.Loc,
): $.DStatementAssign =>
...
export const isDStatementAssign = ($value: DStatementAssign) =>
    $value.kind === "statement_assign";
export type DStatementAugmentedAssign = $.DStatementAugmentedAssign;
export const DStatementAugmentedAssign = (
...
export const isDStatementAugmentedAssign = (
    $value: DStatementAugmentedAssign,
) => $value.kind === "statement_augmentedassign";
export type DestructPattern = $.DestructPattern;
export const DestructPattern = (
    field: $c.Id,
...
export const DStatementDestruct = (
    type_: $c.TypeId,
    identifiers: Ordered<$.DestructPattern>,
...
export const isDStatementDestruct = ($value: DStatementDestruct) =>
    $value.kind === "statement_destruct";
export type DStatementBlock = $.DStatementBlock;
export const DStatementBlock = (
    statements: $.DStatementList,
    loc: $c.Loc,
): $.DStatementBlock =>
    Object.freeze({
...
export const isDStatementForEach = ($value: DStatementForEach) =>
    $value.kind === "statement_foreach";
export type DCatchBlock = $.DCatchBlock;
export const DCatchBlock = (
    catchName: $c.OptionalId,
    catchStatements: $.DStatementList,
): $.DCatchBlock =>
    Object.freeze({
        name: catchName,
...
export const DStatementTry = (
    statements: $.DStatementList,
    catchBlock: $.DCatchBlock | undefined,
    loc: $c.Loc,
): $.DStatementTry =>
    Object.freeze({
        kind: "statement_try",
...
export const isDStatementTry = ($value: DStatementTry) =>
    $value.kind === "statement_try";
export type DStatementRepeat = $.DStatementRepeat;
export const DStatementRepeat = (
    iterations: $e.DecodedExpression,
    statements: $.DStatementList,
    loc: $c.Loc,
): $.DStatementRepeat =>
    Object.freeze({
...
export const isDStatementRepeat = ($value: DStatementRepeat) =>
    $value.kind === "statement_repeat";
export type DStatementUntil = $.DStatementUntil;
export const DStatementUntil = (
    condition: $e.DecodedExpression,
    statements: $.DStatementList,
    loc: $c.Loc,
): $.DStatementUntil =>
    Object.freeze({
...
export const isDStatementUntil = ($value: DStatementUntil) =>
    $value.kind === "statement_until";
export type DStatementWhile = $.DStatementWhile;
export const DStatementWhile = (
    condition: $e.DecodedExpression,
    statements: $.DStatementList,
    loc: $c.Loc,
): $.DStatementWhile =>
...
export const isDStatementWhile = ($value: DStatementWhile) =>
    $value.kind === "statement_while";
export type DStatementList = $.DStatementList;
export type DStatementCondition = $.DStatementCondition;
export const DStatementCondition = (
    condition: $e.DecodedExpression,
    trueStatements: $.DStatementList,
    falseStatements: $.DStatementList | undefined,
    loc: $c.Loc,
): $.DStatementCondition =>
    Object.freeze({
...
export const isDStatementCondition = ($value: DStatementCondition) =>
