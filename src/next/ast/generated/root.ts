...
export const Import = (importPath: $.ImportPath, loc: $c.Range): $.Import =>
    Object.freeze({
        kind: "import",
        importPath,
        loc,
...
export const FunctionAttributeGet = (
    methodId: $e.Expression | undefined,
    loc: $c.Range,
...
export const isFunctionAttributeGet = ($value: FunctionAttributeGet) =>
    $value.kind === "function_attribute";
export type FunctionAttributeName = $.FunctionAttributeName;
export const allFunctionAttributeName: readonly $.FunctionAttributeName[] = [
    "mutates",
    "extends",
    "virtual",
    "abstract",
...
export const FunctionAttributeRest = (
    type_: $.FunctionAttributeName,
    loc: $c.Range,
): $.FunctionAttributeRest =>
    Object.freeze({
        kind: "function_attribute",
        type: type_,
        loc,
    });
export const isFunctionAttributeRest = ($value: FunctionAttributeRest) =>
    $value.kind === "function_attribute";
...
export const isTypedParameter = ($value: TypedParameter) =>
    $value.kind === "typed_parameter";
...
export const FunctionDef = (
    ...
    return_: $t.Type | undefined,
    params: readonly $.TypedParameter[],
    statements: readonly $s.Statement[],
    loc: $c.Range,
): $.FunctionDef =>
    Object.freeze({
        kind: "function_def",
...
export const isFunctionDef = ($value: FunctionDef) =>
    $value.kind === "function_def";
export type AsmShuffle = $.AsmShuffle;
export const AsmShuffle = (
    args: readonly $c.Id[],
    ret: readonly $e.Number[],
): $.AsmShuffle =>
    Object.freeze({
        args,
        ret,
...
export const isAsmFunctionDef = ($value: AsmFunctionDef) =>
    $value.kind === "asm_function_def";
...
export const isNativeFunctionDecl = ($value: NativeFunctionDecl) =>
    $value.kind === "native_function_decl";
export type ConstantAttributeName = $.ConstantAttributeName;
export const allConstantAttributeName: readonly $.ConstantAttributeName[] = [
    "virtual",
    "override",
    "abstract",
];
export type ConstantAttribute = $.ConstantAttribute;
export const ConstantAttribute = (
    type_: $.ConstantAttributeName,
    loc: $c.Range,
): $.ConstantAttribute =>
    Object.freeze({
        type: type_,
...
export const isConstantDef = ($value: ConstantDef) =>
    $value.kind === "constant_def";
export type FieldDecl = $.FieldDecl;
export const FieldDecl = (
    name: $c.Id,
    type_: $t.Type,
    initializer: $e.Expression | undefined,
    loc: $c.Range,
): $.FieldDecl =>
    Object.freeze({
        kind: "field_decl",
...
export const isStructDecl = ($value: StructDecl) =>
    $value.kind === "struct_decl";
export type MessageDecl = $.MessageDecl;
export const MessageDecl = (
    name: $c.TypeId,
    opcode: $e.Expression | undefined,
    fields: readonly $.FieldDecl[],
    loc: $c.Range,
): $.MessageDecl =>
    Object.freeze({
...
export const isMessageDecl = ($value: MessageDecl) =>
    $value.kind === "message_decl";
export type ContractAttribute = $.ContractAttribute;
export const ContractAttribute = (
    name: string,
    loc: $c.Range,
): $.ContractAttribute =>
    Object.freeze({
...
export const isContractInit = ($value: ContractInit) =>
    $value.kind === "contract_init";
export type ReceiverSimple = $.ReceiverSimple;
export const ReceiverSimple = (param: $.TypedParameter): $.ReceiverSimple =>
    Object.freeze({
        kind: "simple",
        param,
    });
export const isReceiverSimple = ($value: ReceiverSimple) =>
    $value.kind === "simple";
export type ReceiverFallback = $.ReceiverFallback;
export const ReceiverFallback = (): $.ReceiverFallback =>
    Object.freeze({
        kind: "fallback",
    });
export const isReceiverFallback = ($value: ReceiverFallback) =>
    $value.kind === "fallback";
export type ReceiverComment = $.ReceiverComment;
export const ReceiverComment = (comment: $e.String): $.ReceiverComment =>
    Object.freeze({
        kind: "comment",
        comment,
    });
export const isReceiverComment = ($value: ReceiverComment) =>
    $value.kind === "comment";
export type ReceiverSubKind = $.ReceiverSubKind;
export type ReceiverInternal = $.ReceiverInternal;
export const ReceiverInternal = (
    subKind: $.ReceiverSubKind,
    loc: $c.Range,
): $.ReceiverInternal =>
    Object.freeze({
        kind: "internal",
...
export const isReceiverInternal = ($value: ReceiverInternal) =>
    $value.kind === "internal";
export type ReceiverExternal = $.ReceiverExternal;
export const ReceiverExternal = (
    subKind: $.ReceiverSubKind,
    loc: $c.Range,
): $.ReceiverExternal =>
    Object.freeze({
...
export const isReceiverExternal = ($value: ReceiverExternal) =>
    $value.kind === "external";
export type ReceiverBounce = $.ReceiverBounce;
export const ReceiverBounce = (
...
export const isReceiverBounce = ($value: ReceiverBounce) =>
    $value.kind === "bounce";
export type ReceiverKind = $.ReceiverKind;
export type Receiver = $.Receiver;
export const Receiver = (
    selector: $.ReceiverKind,
    statements: readonly $s.Statement[],
    loc: $c.Range,
): $.Receiver =>
    Object.freeze({
...
export const Contract = (
    name: $c.TypeId,
    traits: readonly $c.TypeId[],
    attributes: readonly $.ContractAttribute[],
    params: readonly $.FieldDecl[] | undefined,
    declarations: readonly $.ContractItem[],
    loc: $c.Range,
): $.Contract =>
    Object.freeze({
        kind: "contract",
...
export const isFunctionDecl = ($value: FunctionDecl) =>
    $value.kind === "function_decl";
export type ConstantDecl = $.ConstantDecl;
export const ConstantDecl = (
    attributes: readonly $.ConstantAttribute[],
    name: $c.Id,
    type_: $t.Type,
    loc: $c.Range,
...
export const isConstantDecl = ($value: ConstantDecl) =>
    $value.kind === "constant_decl";
...
export const Trait = (
    ...
    traits: readonly $c.TypeId[],
    attributes: readonly $.ContractAttribute[],
    declarations: readonly $.TraitItem[],
    loc: $c.Range,
): $.Trait =>
    Object.freeze({
        kind: "trait",
