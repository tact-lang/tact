...
export const Import = (importPath: $.ImportPath, loc: $c.Loc): $.Import =>
    Object.freeze({
        kind: "import",
        importPath,
        loc,
...
export const isRegularBody = ($value: RegularBody) =>
    $value.kind === "regular_body";
...
export const NativeBody = (nativeName: $c.FuncId): $.NativeBody =>
    Object.freeze({
        kind: "native_body",
        nativeName,
    });
export const isNativeBody = ($value: NativeBody) =>
    $value.kind === "native_body";
export type AbstractBody = $.AbstractBody;
export const AbstractBody = (): $.AbstractBody =>
    Object.freeze({
        kind: "abstract_body",
    });
export const isAbstractBody = ($value: AbstractBody) =>
    $value.kind === "abstract_body";
...
export const ConstantDecl = (type_: $t.Type): $.ConstantDecl =>
    Object.freeze({
        kind: "constant_decl",
        type: type_,
    });
...
export const InitFunction = (
    params: readonly $t.TypedParameter[],
    statements: readonly $s.Statement[],
    loc: $c.Loc,
): $.InitFunction =>
    Object.freeze({
...
export const isInitFunction = ($value: InitFunction) =>
    $value.kind === "init_function";
export type InitParams = $.InitParams;
export const InitParams = (
    params: readonly $.FieldDecl[],
    loc: $c.Loc,
): $.InitParams =>
    Object.freeze({
        kind: "init_params",
...
export const isInitParams = ($value: InitParams) =>
    $value.kind === "init_params";
...
export const ReceiverSimple = (param: $t.TypedParameter): $.ReceiverSimple =>
    Object.freeze({
        kind: "simple",
        param,
    });
...
export const isFieldConstant = ($value: FieldConstant) =>
    $value.kind === "field_const";
