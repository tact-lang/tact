...
export const IFInt = (sign: $.Signedness, width: number, loc: $c.Range): $.IFInt => Object.freeze({
  kind: "FInt",
  sign,
  width,
  loc
...
export const IFVarInt = (sign: $.Signedness, width: $.VarIntWidth, loc: $c.Range): $.IFVarInt => Object.freeze({
  kind: "FVarInt",
  sign,
  width,
  loc
...
export const TypeInt = (format: $.IntFormat, loc: $c.Range): $.TypeInt => Object.freeze({
  kind: "TyInt",
  format,
  loc
});
...
export const SFBits = (bits: number, loc: $c.Range): $.SFBits => Object.freeze({
  kind: "SFBits",
  bits,
  loc
});
...
export const SFRemaining = (loc: $c.Range): $.SFRemaining => Object.freeze({
  kind: "SFRemaining",
  loc
});
export const isSFRemaining = ($value: SFRemaining) => $value.kind === "SFRemaining";
export type SFDefault = $.SFDefault;
export const SFDefault = (loc: $c.Range): $.SFDefault => Object.freeze({
  kind: "SFDefault",
  loc
});
...
export const TypeSlice = (format: $.SliceFormat, loc: $c.Range): $.TypeSlice => Object.freeze({
  kind: "TySlice",
  format,
  loc
});
...
export const TypeCell = (format: $.RemFormat, loc: $c.Range): $.TypeCell => Object.freeze({
  kind: "TyCell",
  format,
  loc
});
...
export const TypeBuilder = (format: $.RemFormat, loc: $c.Range): $.TypeBuilder => Object.freeze({
  kind: "TyBuilder",
  format,
  loc
});
export const isTypeBuilder = ($value: TypeBuilder) => $value.kind === "TyBuilder";
export type TypeUnit = $.TypeUnit;
export const TypeUnit = (loc: $c.Range): $.TypeUnit => Object.freeze({
  kind: "unit_type",
  loc
});
export const isTypeUnit = ($value: TypeUnit) => $value.kind === "unit_type";
export type TypeTensor = $.TypeTensor;
export const TypeTensor = (typeArgs: readonly $.Type[], loc: $c.Range): $.TypeTensor => Object.freeze({
  kind: "tensor_type",
  typeArgs,
  loc
});
export const isTypeTensor = ($value: TypeTensor) => $value.kind === "tensor_type";
export type TypeTuple = $.TypeTuple;
export const TypeTuple = (typeArgs: readonly $.Type[], loc: $c.Range): $.TypeTuple => Object.freeze({
  kind: "tuple_type",
  typeArgs,
  loc
});
...
export const TypeCons = (name: $c.TypeId, typeArgs: readonly $.Type[], loc: $c.Range): $.TypeCons => Object.freeze({
  kind: "cons_type",
  name,
  typeArgs,
  loc
