...
export const MGTypeRef = (
    name: $c.TypeId,
    type: TypeDeclRefable,
    typeArgs: readonly $.MethodGroundType[],
    loc: $c.Loc,
): $.MGTypeRef =>
    Object.freeze({
        ground: "yes",
...
export const MGTypeMaybe = (
    type_: $.MethodGroundType,
    loc: $c.Loc,
): $.MGTypeMaybe =>
    Object.freeze({
        ground: "yes",
...
export const isMGTypeMaybe = ($value: MGTypeMaybe) =>
    $value.kind === "TypeMaybe";
export type MGTypeMap = $.MGTypeMap;
export const MGTypeMap = (
    key: $.MethodGroundType,
    value: $.MethodGroundType,
    loc: $c.Loc,
): $.MGTypeMap =>
    Object.freeze({
        ground: "yes",
...
export const isMGTypeTuple = ($value: MGTypeTuple) =>
    $value.kind === "tuple_type";
export type MGTypeTensor = $.MGTypeTensor;
export const MGTypeTensor = (
    typeArgs: readonly $.MethodGroundType[],
    loc: $c.Loc,
): $.MGTypeTensor =>
    Object.freeze({
...
export const isMGTypeTensor = ($value: MGTypeTensor) =>
    $value.kind === "tensor_type";
export type MVTypeRef = $.MVTypeRef;
export const MVTypeRef = (
    name: $c.TypeId,
    type: TypeDeclRefable,
    typeArgs: readonly $d.DTypeParamRef[],
    loc: $c.Loc,
): $.MVTypeRef =>
    Object.freeze({
        ground: "no",
...
export const MVTypeMaybe = (
    type_: $d.DTypeParamRef,
    loc: $c.Loc,
): $.MVTypeMaybe =>
    Object.freeze({
        ground: "no",
...
export const isMVTypeMaybe = ($value: MVTypeMaybe) =>
    $value.kind === "TypeMaybe";
export type MVTypeMap = $.MVTypeMap;
export const MVTypeMap = (
    key: $d.DTypeParamRef,
    value: $d.DTypeParamRef,
    loc: $c.Loc,
): $.MVTypeMap =>
    Object.freeze({
        ground: "no",
...
export const isMVTypeTuple = ($value: MVTypeTuple) =>
    $value.kind === "tuple_type";
export type MVTypeTensor = $.MVTypeTensor;
export const MVTypeTensor = (
    typeArgs: readonly $d.DTypeParamRef[],
    loc: $c.Loc,
): $.MVTypeTensor =>
    Object.freeze({
...
export const isMVTypeTensor = ($value: MVTypeTensor) =>
    $value.kind === "tensor_type";
