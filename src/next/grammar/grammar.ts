...
export namespace $ast {
  ...
  export type primary = Unit | Tensor | Tuple | Parens | StructInstance | IntegerLiteral | BoolLiteral | InitOf | CodeOf | Null | StringLiteral | Id;
...
export const primary: $.Parser<$ast.primary> = $.alt(Unit, $.alt(Tensor, $.alt(Tuple, $.alt(Parens, $.alt(StructInstance, $.alt(IntegerLiteral, $.alt(BoolLiteral, $.alt(InitOf, $.alt(CodeOf, $.alt(Null, $.alt(StringLiteral, Id)))))))))));
