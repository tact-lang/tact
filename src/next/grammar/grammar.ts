...
export namespace $ast {
    ...
    export type inheritedTraits = commaList<TypeId>;
    ...
    export type IntStorage = $.Located<{
        readonly $: "IntStorage";
        readonly isVar: "var" | undefined;
        readonly isUnsigned: "u" | undefined;
        readonly width: string;
    }>;
    export type CoinsStorage = $.Located<{
        readonly $: "CoinsStorage";
    }>;
    export type RemainingStorage = $.Located<{
        readonly $: "RemainingStorage";
    }>;
    export type BytesStorage = $.Located<{
        readonly $: "BytesStorage";
        readonly width: string;
    }>;
    export type storage =
        | IntStorage
    ...
    export type typeParams = generic<TypeId>;
    ...
    export type Unit = $.Located<{
        readonly $: "Unit";
    }>;
    export type Tensor = $.Located<{
        readonly $: "Tensor";
    ...
    export type Tuple = $.Located<{
        readonly $: "Tuple";
        readonly types: commaList<expression> | undefined;
    }>;
    ...
    export type StaticCall = $.Located<{
        readonly $: "StaticCall";
        readonly type: TypeId;
        readonly typeArgs: typeArgs | undefined;
        readonly name: Id;
        readonly args: parameterList<expression>;
    }>;
...
export const Module: $.Parser<$ast.Module> = $.loc(
    $.field(
        ...
        $.field(
            $.star($.lazy(() => Import)),
            "imports",
            $.field($.star($.lazy(() => moduleItem)), "items", $.eps),
        ),
    ),
);
...
export const $Function: $.Parser<$ast.$Function> = $.loc(
    $.field(
        ...
        "$",
        $.field(
            $.star($.lazy(() => FunctionAttribute)),
            "attributes",
            $.right(
                $.lazy(() => keyword($.str("fun"))),
                $.field(
                    $.lazy(() => Id),
                    "name",
                    $.field(
...
export const Constant: $.Parser<$ast.Constant> = $.loc(
    $.field(
        ...
        "$",
        $.field(
            $.star($.lazy(() => ConstantAttribute)),
            "attributes",
            $.right(
                $.lazy(() => keyword($.str("const"))),
                $.field(
                    $.lazy(() => Id),
                    "name",
                    $.field(
                        ...
                        $.field(
                            $.alt(
                                $.lazy(() => ConstantDefinition),
                                $.lazy(() => ConstantDeclaration),
                            ),
                            "body",
                            $.eps,
                        ),
...
export const UnionDecl: $.Parser<$ast.UnionDecl> = $.loc(
    $.field(
        $.pure("UnionDecl"),
        "$",
        $.right(
...
export const AliasDecl: $.Parser<$ast.AliasDecl> = $.loc(
    $.field(
        $.pure("AliasDecl"),
        "$",
        $.right(
...
export const Contract: $.Parser<$ast.Contract> = $.loc(
    $.field(
        ...
        "$",
        $.field(
            $.star($.lazy(() => ContractAttribute)),
            "attributes",
            $.right(
                $.lazy(() => keyword($.str("contract"))),
                $.field(
                    $.lazy(() => TypeId),
                    "name",
                    $.field(
                        ...
                        "parameters",
                        $.field(
                            $.opt($.lazy(() => inheritedTraits)),
                            "traits",
                            $.right(
                                $.str("{"),
                                $.field(
                                    $.star($.lazy(() => contractItemDecl)),
                                    "declarations",
                                    $.right($.str("}"), $.eps),
                                ),
                            ),
                ...
                $.alt(
                    ...
                    $.alt(
                        ...
                        $.alt(
                            ...
                            $.alt(
                                UnionDecl,
                                $.alt(AliasDecl, $.alt(Contract, Trait)),
                            ),
                        ),
                    ),
                ),
...
export const ContractInit: $.Parser<$ast.ContractInit> = $.loc(
    $.field(
        ...
        $.right(
            $.str("init"),
            $.field(
                $.lazy(() => parameterList($.lazy(() => Parameter))),
                "parameters",
                $.field(
                    $.lazy(() => statements),
                    "body",
...
export const contractItemDecl: $.Parser<$ast.contractItemDecl> = $.alt(
    ...
    $.alt(
        Receiver,
        $.alt($Function, $.alt(AsmFunction, $.alt(Constant, storageVar))),
    ),
);
...
export const IntegerLiteralDec: $.Parser<$ast.IntegerLiteralDec> = $.loc(
    $.field(
        ...
        "$",
        $.field(
            $.lex($.lazy(() => underscored($.lazy(() => digit)))),
            "digits",
            $.eps,
        ),
    ),
...
export const ConstantAttribute: $.Parser<$ast.ConstantAttribute> = $.loc(
    $.field(
        ...
        $.field(
            $.alt(
                $.lazy(() => keyword($.str("virtual"))),
                $.alt(
                    $.lazy(() => keyword($.str("override"))),
                    $.lazy(() => keyword($.str("abstract"))),
                ),
            ),
            "name",
            $.eps,
...
export const Case: $.Parser<$ast.Case> = $.loc(
    $.field(
        $.pure("Case"),
        "$",
        $.field(
...
export const ReceiverType: $.Parser<$ast.ReceiverType> = $.loc(
    $.field(
        $.pure("ReceiverType"),
        "$",
        $.field(
...
export const assemblySequence: $.Parser<$ast.assemblySequence> =
    $.star(assemblyItem);
export const TypeAs: $.Parser<$ast.TypeAs> = $.loc(
    $.field(
        $.pure("TypeAs"),
        "$",
        $.field(
            ...
            $.field(
                $.star(
                    $.right(keyword($.str("as")), $.lex($.lazy(() => storage))),
                ),
                "as",
                $.eps,
            ),
...
export const TypeOptional: $.Parser<$ast.TypeOptional> = $.loc(
    $.field(
        ...
        $.field(
            $.lazy(() => typePrimary),
            "type",
            $.field($.star($.lazy(() => Optional)), "optionals", $.eps),
        ),
    ),
);
export const Optional: $.Parser<$ast.Optional> = $.loc(
    $.field($.pure("Optional"), "$", $.right($.str("?"), $.eps)),
);
export const TypeGeneric: $.Parser<$ast.TypeGeneric> = $.loc(
    $.field(
        $.pure("TypeGeneric"),
        "$",
        $.field(
...
export const TypeRegular: $.Parser<$ast.TypeRegular> = $.loc(
    $.field($.pure("TypeRegular"), "$", $.field(TypeId, "child", $.eps)),
);
export const TypeStorage: $.Parser<$ast.TypeStorage> = $.loc(
    $.field(
        $.pure("TypeStorage"),
        "$",
        $.field(
...
export const TypeTuple: $.Parser<$ast.TypeTuple> = $.loc(
    $.field(
        $.pure("TypeTuple"),
        "$",
        $.right(
...
export const TypeTensor: $.Parser<$ast.TypeTensor> = $.loc(
    $.field(
        $.pure("TypeTensor"),
        "$",
        $.right(
...
export const TypeUnit: $.Parser<$ast.TypeUnit> = $.loc(
    $.field(
        $.pure("TypeUnit"),
        "$",
        $.right($.right($.str("("), $.right($.str(")"), $.eps)), $.eps),
    ),
);
export const typeParens: $.Parser<$ast.typeParens> = $.right(
    $.str("("),
    $.left($type, $.str(")")),
);
export const typePrimary: $.Parser<$ast.typePrimary> = $.alt(
    TypeGeneric,
    $.alt(
        TypeRegular,
        $.alt(
            TypeStorage,
            $.alt(TypeTuple, $.alt(TypeTensor, $.alt(TypeUnit, typeParens))),
        ),
    ),
);
export const MapKeyword: $.Parser<$ast.MapKeyword> = $.loc(
    $.field($.pure("MapKeyword"), "$", $.right(keyword($.str("map")), $.eps)),
);
export const Bounced: $.Parser<$ast.Bounced> = $.loc(
    $.field($.pure("Bounced"), "$", $.right($.str("bounced"), $.eps)),
);
export const IntStorage: $.Parser<$ast.IntStorage> = $.loc(
    $.field(
        $.pure("IntStorage"),
        "$",
        $.field(
...
export const CoinsStorage: $.Parser<$ast.CoinsStorage> = $.loc(
    $.field($.pure("CoinsStorage"), "$", $.right($.str("coins"), $.eps)),
);
export const RemainingStorage: $.Parser<$ast.RemainingStorage> = $.loc(
    $.field(
        $.pure("RemainingStorage"),
        "$",
        $.right($.str("remaining"), $.eps),
    ),
);
export const BytesStorage: $.Parser<$ast.BytesStorage> = $.loc(
    $.field(
        $.pure("BytesStorage"),
        "$",
        $.right(
            $.str("bytes"),
            $.field($.stry($.plus($.lazy(() => digit))), "width", $.eps),
        ),
    ),
);
export const storage: $.Parser<$ast.storage> = $.alt(
    IntStorage,
    $.alt(CoinsStorage, $.alt(RemainingStorage, BytesStorage)),
);
export const generic = <T>(T: $.Parser<T>): $.Parser<$ast.generic<T>> =>
    $.right($.str("<"), $.left($.opt(commaList($.lazy(() => T))), $.str(">")));
...
export const Suffix: $.Parser<$ast.Suffix> = $.loc(
    $.field(
        ...
        $.field(
            $.lazy(() => primary),
            "expression",
            $.field($.star($.lazy(() => suffix)), "suffixes", $.eps),
        ),
    ),
);
...
export const Unit: $.Parser<$ast.Unit> = $.loc(
    $.field(
        $.pure("Unit"),
        "$",
        $.right($.right($.str("("), $.right($.str(")"), $.eps)), $.eps),
...
export const Tensor: $.Parser<$ast.Tensor> = $.loc(
    $.field(
        $.pure("Tensor"),
        "$",
        $.right(
        ...
        $.field(
            ...
            $.field(
                ...
                $.right(
                    $.str("{"),
                    $.field(
                        $.opt(commaList($.lazy(() => StructFieldInitializer))),
                        "fields",
                        $.right($.str("}"), $.eps),
                    ),
                ),
...
export const StaticCall: $.Parser<$ast.StaticCall> = $.loc(
    $.field(
        $.pure("StaticCall"),
        "$",
        $.field(
...
export const CodeOf: $.Parser<$ast.CodeOf> = $.loc(
    $.field(
        $.pure("CodeOf"),
        "$",
        $.right($.str("codeOf"), $.field(TypeId, "name", $.eps)),
    ),
);
...
export const FuncId: $.Parser<$ast.FuncId> = $.named(
    "FunC identifier",
    $.loc(
        $.field(
            $.pure("FuncId"),
