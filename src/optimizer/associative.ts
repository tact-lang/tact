            ...
            if (checkIsBinaryOp_NonValue_Value(topLevelNode.left) && isValue(topLevelNode.right)) {
                ...
                try {
                    ...
                    if (
                        ...
                        // popportunity for simplification that was missed 
                        // previously
                        return optimizer.applyRules(makeBinaryExpression(op1, x1, newConstant));
                    }
                } catch(e) {
                }
                ...
                try {
                    ...
                    if (
                        ...
                        // popportunity for simplification that was missed 
                        // previously
                        return optimizer.applyRules(makeBinaryExpression(op1, newConstant, x1));
                    }
                } catch(e) {
                }
            }
