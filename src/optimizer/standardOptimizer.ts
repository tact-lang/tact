...
export class StandardOptimizer extends ExpressionTransformer {
    ...
    constructor() {
        ...
        this.rules = [
            ...
            { priority: 8, rule: new DivByZero() },
            { priority: 9, rule: new OrTrue() },
            { priority: 10, rule: new AndFalse() },
            { priority: 11, rule: new OrFalse() },
            { priority: 12, rule: new AndTrue() },
            { priority: 13, rule: new OrSelf() },
            { priority: 14, rule: new AndSelf() },
            { priority: 15, rule: new ExcludedMiddle() },
            { priority: 16, rule: new Contradiction() },
            { priority: 17, rule: new DoubleNegation() },
            { priority: 18, rule: new NegateTrue() },
            { priority: 19, rule: new NegateFalse() },
        ];
