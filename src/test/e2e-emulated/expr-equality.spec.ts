...
const structExpressions: Test[] = [
    {expr1: "Test {f1: a, f2: b}", expr2: "Test {f1: a, f2: b}", equality: true},
    {expr1: "Test {f1: a, f2: b}", expr2: "Test2 {f1: a, f2: b}", equality: false},
    {expr1: "Test {f1: a, f2: b}", expr2: "Test {f3: a, f2: b}", equality: false},
    {expr1: "Test {f1: a, f2: b}", expr2: "Test {f1: a, f3: b}", equality: false},
    {expr1: "Test {f1: a, f2: b}", expr2: "Test {f1: c, f2: b}", equality: false},
    {expr1: "Test {f1: a, f2: b}", expr2: "Test {f1: a, f2: c}", equality: false},
    {expr1: "Test {f1: a, f2: b}", expr2: "Test {f1: a}", equality: false},
    {expr1: "Test {f1: a, f2: b}", expr2: "Test {f1: a, f2: b, f3: c}", equality: false},
...
const fieldAccessExpressions: Test[] = [
    ...
    {expr1: "Test {a: e1, b: e2}.a", expr2: "Test {a: e1, b: e2}.a", equality: true},
    ...
    {expr1: "Test {a: e1, b: e2}.a", expr2: "Test {a: e1, b: e2}.b", equality: false},
];
