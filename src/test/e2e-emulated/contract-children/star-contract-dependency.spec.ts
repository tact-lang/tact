...
import { Parent } from "./output/star-contract-dependency_Parent";
import { Child0 } from "./output/star-contract-dependency_Child0";
import { Child1 } from "./output/star-contract-dependency_Child1";
import { Child2 } from "./output/star-contract-dependency_Child2";
import { Child3 } from "./output/star-contract-dependency_Child3";
import { Child4 } from "./output/star-contract-dependency_Child4";
import { Child5 } from "./output/star-contract-dependency_Child5";
import { Child6 } from "./output/star-contract-dependency_Child6";
import { Child7 } from "./output/star-contract-dependency_Child7";
