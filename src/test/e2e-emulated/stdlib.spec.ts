...
describe("stdlib", () => {
    ...
    it("should execute stdlib methods correctly", async () => {
        ...
        expect(Number(await contract.getTvm_2023_07Upgrade())).toMatchSnapshot("tvm_2023_07Upgrade");
        ...
        expect(Number(await contract.getSetGasLimit(5000n))).toMatchSnapshot("Gas consumed in segGasLimit()"); // 5000 just to make sure it's enough, 3785 is how much it actually costs
