...
describe("stdlib", () => {
    ...
    it("should execute stdlib methods correctly", async () => {
        ...
        expect(await contract.getTvm_2023_07Upgrade()).toEqual(1243n);
        ...
        expect(await contract.getSetGasLimit(5000n)).toBe(3785n); // 5000 just to make sure it's enough, 3785 is how much it actually costs
