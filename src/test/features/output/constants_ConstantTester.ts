...
export class ConstantTester {
    ...
    async getSomething1() {
        try {
            let __stack: StackItem[] = [];
            let result = await this.executor.get('something1', __stack, { debug: true });
    ...
    async getSomething2() {
        try {
            let __stack: StackItem[] = [];
            let result = await this.executor.get('something2', __stack, { debug: true });
            if (result.debugLogs.length > 0) { console.warn(result.debugLogs); }
    ...
    async getSomething3() {
        try {
            let __stack: StackItem[] = [];
            let result = await this.executor.get('something3', __stack, { debug: true });
            if (result.debugLogs.length > 0) { console.warn(result.debugLogs); }
            return result.stack.readBigNumber();
        } catch (e) {
            if (e instanceof ExecuteError) {
    ...
    async getSomething4() {
        try {
            let __stack: StackItem[] = [];
            let result = await this.executor.get('something4', __stack, { debug: true });
            if (result.debugLogs.length > 0) { console.warn(result.debugLogs); }
            return result.stack.readBigNumber();
        } catch (e) {
            if (e instanceof ExecuteError) {
    ...
    async getSomething5() {
        try {
            let __stack: StackItem[] = [];
            let result = await this.executor.get('something5', __stack, { debug: true });
            if (result.debugLogs.length > 0) { console.warn(result.debugLogs); }
