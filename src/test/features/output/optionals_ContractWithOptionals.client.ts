...
async function ContractWithOptionals_init(a: bigint | null, b: boolean | null, c: Cell | null, d: Address | null, e: SomeGenericStruct | null, f: StructWithOptionals | null, opts?: { engine?: ExecutorEngine }) {
    ...
    const __code = '';
    const __system = '';
    ...
    if (res.exitCode !== 0 && res.exitCode !== 1) {
        if (ContractWithOptionals_errors[res.exitCode]) {
            throw new ComputeError(ContractWithOptionals_errors[res.exitCode].message, res.exitCode, { logs: res.logs });
        } else {
...
export class ContractWithOptionals implements Contract {
    ...
    static async init(a: bigint | null, b: boolean | null, c: Cell | null, d: Address | null, e: SomeGenericStruct | null, f: StructWithOptionals | null, opts?: { engine?: ExecutorEngine }) {
        return await ContractWithOptionals_init(a, b, c, d, e, f, opts);
    }
    
    static async fromInit(a: bigint | null, b: boolean | null, c: Cell | null, d: Address | null, e: SomeGenericStruct | null, f: StructWithOptionals | null, opts?: { engine?: ExecutorEngine }) {
        const init = await ContractWithOptionals_init(a, b, c, d, e, f, opts);
