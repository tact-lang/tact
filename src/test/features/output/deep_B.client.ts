...
export class B implements Contract {
    ...
    static async init(parent: Address, opts?: { engine?: ExecutorEngine }) {
        return await B_init(parent, opts);
    }
    
    static async fromInit(parent: Address, opts?: { engine?: ExecutorEngine }) {
        const init = await B_init(parent, opts);
