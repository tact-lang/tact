...
async function ConstantTester_init(opts?: { engine?: ExecutorEngine }) {
    const __init = 'te6ccgEBBAEAIwABFP8A9KQT9LzyyAsBAgFiAgMAAtAAF6FK3ZGY4AOUANphkw==';
    const __code = '';
    const __system = '';
    ...
    if (res.exitCode !== 0 && res.exitCode !== 1) {
        if (ConstantTester_errors[res.exitCode]) {
            throw new ComputeError(ConstantTester_errors[res.exitCode].message, res.exitCode, { logs: res.logs });
        } else {
...
export class ConstantTester implements Contract {
    ...
    static async init(opts?: { engine?: ExecutorEngine }) {
        return await ConstantTester_init(opts);
    }
    
    static async fromInit(opts?: { engine?: ExecutorEngine }) {
        const init = await ConstantTester_init(opts);
