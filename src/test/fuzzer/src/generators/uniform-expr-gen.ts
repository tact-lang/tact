...
const allProductions: ExprProduction[][] = [
    ...
    [
        ...
        { id: 11, tokens: [Terminal.unary_minus, NonTerminal.Int] },
        { id: 12, tokens: [Terminal.bit_not, NonTerminal.Int] },

        { id: 13, tokens: [Terminal.non_null_assert, NonTerminal.OptInt] },
        {
            id: 14,
            tokens: [
                Terminal.cond,
        ...
        { id: 15, tokens: [Terminal.id_int] },
        { id: 16, tokens: [NonTerminal.LiteralInt] },
    ],
    [
