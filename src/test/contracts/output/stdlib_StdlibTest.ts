...
async function StdlibTest_init() {
    ...
    const __code = '';
    const __system = '';
    ...
    if (res.exitCode !== 0 && res.exitCode !== 1) {
        if (StdlibTest_errors[res.exitCode]) {
            throw new ComputeError(StdlibTest_errors[res.exitCode].message, res.exitCode, { logs: res.vmLogs });
        } else {
