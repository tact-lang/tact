...
async function StdlibTest_init(opts?: { engine?: ExecutorEngine }) {
    const __init = 'te6ccgEBBgEAMAABFP8A9KQT9LzyyAsBAgFiAgMCAs4EBQAJoUrd4AUAAUgAGUcAHIzAEBgQEBzwDJg=';
    const __code = '';
    const __system = '';
...
export class StdlibTest implements Contract {
    ...
    static async init(opts?: { engine?: ExecutorEngine }) {
        return await StdlibTest_init(opts);
    }
    
    static async fromInit(opts?: { engine?: ExecutorEngine }) {
        const init = await StdlibTest_init(opts);
