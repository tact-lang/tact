...
async function Empty_init(opts?: { engine?: ExecutorEngine }) {
    ...
    const __code = '';
    const __system = '';
...
export class Empty implements Contract {
    ...
    static async init(opts?: { engine?: ExecutorEngine }) {
        return await Empty_init(opts);
    }
    
    static async fromInit(opts?: { engine?: ExecutorEngine }) {
        const init = await Empty_init(opts);
