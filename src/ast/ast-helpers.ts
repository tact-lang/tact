...
export function ensureFunctionDef(ast: A.AstNode): A.AstFunctionDef {
...
export function ensureConstantDef(ast: A.AstNode): A.AstConstantDef {
    // Type AstMutableNode restricts the possibilities of the
...
export function ensureContractInit(ast: A.AstNode): A.AstContractInit {
...
export function ensureFieldDecl(ast: A.AstNode): A.AstFieldDecl {
...
export function ensureReceiver(ast: A.AstNode): A.AstReceiver {
...
export function isAstExpression(ast: A.AstNode): ast is A.AstExpression {
...
function checkAstExpression<T>(
    ast: A.AstNode,
    t: (node: A.AstExpression) => T,
    f: (node: Exclude<A.AstNode, A.AstExpression>) => T,
): T {
    switch (ast.kind) {
        case "null":
        case "boolean":
