...
const instructions = {
    ...
    ADDINT: cat('add_mul', mkfixedn(0xa6, 8, 8, seq1(int(8)), `exec_add_tinyint8(_1, _2, false)`)),
    MULINT: cat('add_mul', mkfixedn(0xa7, 8, 8, seq1(int(8)), `exec_mul_tinyint8(_1, _2, false)`)),
    QADDINT: cat('add_mul', mkfixedn(0xb7a6, 16, 8, seq1(int(8)), `exec_add_tinyint8(_1, _2, true)`)),
    QMULINT: cat('add_mul', mkfixedn(0xb7a7, 16, 8, seq1(int(8)), `exec_mul_tinyint8(_1, _2, true)`)),
    EQINT: cat('int_cmp', mkfixedn(0xc0, 8, 8, seq1(int(8)), `exec_cmp_int(_1, _2, 0x878, false, 'EQ')`)),
    LESSINT: cat('int_cmp', mkfixedn(0xc1, 8, 8, seq1(int(8)), `exec_cmp_int(_1, _2, 0x887, false, 'LESS')`)),
    GTINT: cat('int_cmp', mkfixedn(0xc2, 8, 8, seq1(int(8)), `exec_cmp_int(_1, _2, 0x788, false, 'GT')`)),
    NEQINT: cat('int_cmp', mkfixedn(0xc3, 8, 8, seq1(int(8)), `exec_cmp_int(_1, _2, 0x787, false, 'NEQ')`)),
    QEQINT: cat('int_cmp', mkfixedn(0xb7c0, 16, 8, seq1(int(8)), `exec_cmp_int(_1, _2, 0x878, true, 'QEQ')`)),
    QLESSINT: cat('int_cmp', mkfixedn(0xb7c1, 16, 8, seq1(int(8)), `exec_cmp_int(_1, _2, 0x887, true, 'QLESS')`)),
    QGTINT: cat('int_cmp', mkfixedn(0xb7c2, 16, 8, seq1(int(8)), `exec_cmp_int(_1, _2, 0x788, true, 'QGT')`)),
    QNEQINT: cat('int_cmp', mkfixedn(0xb7c3, 16, 8, seq1(int(8)), `exec_cmp_int(_1, _2, 0x787, true, 'QNEQ')`)),
    ...
    FITS: cat('shift_logic', mkfixedn(0xb4, 8, 8, seq1(delta(1, uint(8))), `exec_fits_tinyint8(_1, _2, false)`)),
    UFITS: cat('shift_logic', mkfixedn(0xb5, 8, 8, seq1(delta(1, uint(8))), `exec_ufits_tinyint8(_1, _2, false)`)),
    QFITS: cat('shift_logic', mkfixedn(0xb7b4, 16, 8, seq1(delta(1, uint(8))), `exec_fits_tinyint8(_1, _2, true)`)),
    QUFITS: cat('shift_logic', mkfixedn(0xb7b5, 16, 8, seq1(delta(1, uint(8))), `exec_ufits_tinyint8(_1, _2, true)`)),
    ...
    CHASHI: version(6, cat('cell_deserialize', mkfixedn(0xd768 >> 2, 14, 2, seq1(uint(2)), `exec_cell_hash_i(_1, _2, false)`))),
    CDEPTHI: version(6, cat('cell_deserialize', mkfixedn(0xd76c >> 2, 14, 2, seq1(uint(2)), `exec_cell_depth_i(_1, _2, false)`))),
    ...
    THROWARG: cat('exception', mkfixedn(0xf2c8 >> 3, 13, 11, seq1(uint(11)), `exec_throw_arg_fixed(_1, _2, 0x7ff, 0)`)),
    THROWARGIF: cat('exception', mkfixedn(0xf2d8 >> 3, 13, 11, seq1(uint(11)), `exec_throw_arg_fixed(_1, _2, 0x7ff, 3)`)),
    THROWARGIFNOT: cat('exception', mkfixedn(0xf2e8 >> 3, 13, 11, seq1(uint(11)), `exec_throw_arg_fixed(_1, _2, 0x7ff, 2)`)),
    ...
    DEBUGSTR: cat('debug', mkext(0, 0xfef, 12, 4, slice(delta(1, uint(4)), 0), `exec_dummy_debug_str`)),

    SETCONTCTR: cat('continuation_change', mkfixedrangen(0xed60, 0xed68, 16, 4, seq1(control), `exec_setcont_ctr`)),
    SETRETCTR: cat('continuation_change', mkfixedrangen(0xed70, 0xed78, 16, 4, seq1(control), `exec_setret_ctr`)),
    SETALTCTR: cat('continuation_change', mkfixedrangen(0xed80, 0xed88, 16, 4, seq1(control), `exec_setalt_ctr`)),
    POPSAVE: cat('continuation_change', mkfixedrangen(0xed90, 0xed98, 16, 4, seq1(control), `exec_popsave_ctr`)),
    SAVECTR: cat('continuation_change', mkfixedrangen(0xeda0, 0xeda8, 16, 4, seq1(control), `exec_save_ctr`)),
    SAVEALTCTR: cat('continuation_change', mkfixedrangen(0xedb0, 0xedb8, 16, 4, seq1(control), `exec_savealt_ctr`)),
    SAVEBOTHCTR: cat('continuation_change', mkfixedrangen(0xedc0, 0xedc8, 16, 4, seq1(control), `exec_saveboth_ctr`)),
    ...
    "ADDRSHIFT#MOD": version(4, cat('div', mkfixedn(0xa930, 16, 8, seq1(delta(1, uint(8))), `exec_shrmod(_1, _2, 2)`))),
    "ADDRSHIFTR#MOD": version(4, cat('div', mkfixedn(0xa931, 16, 8, seq1(delta(1, uint(8))), `exec_shrmod(_1, _2, 2)`))),
    "ADDRSHIFTC#MOD": version(4, cat('div', mkfixedn(0xa932, 16, 8, seq1(delta(1, uint(8))), `exec_shrmod(_1, _2, 2)`))),
    "RSHIFT#": cat('div', mkfixedn(0xa934, 16, 8, seq1(delta(1, uint(8))), `exec_shrmod(_1, _2, 2)`)),
    "RSHIFTR#": cat('div', mkfixedn(0xa935, 16, 8, seq1(delta(1, uint(8))), `exec_shrmod(_1, _2, 2)`)),
    "RSHIFTC#": cat('div', mkfixedn(0xa936, 16, 8, seq1(delta(1, uint(8))), `exec_shrmod(_1, _2, 2)`)),
    "MODPOW2#": cat('div', mkfixedn(0xa938, 16, 8, seq1(delta(1, uint(8))), `exec_shrmod(_1, _2, 2)`)),
    "MODPOW2R#": cat('div', mkfixedn(0xa939, 16, 8, seq1(delta(1, uint(8))), `exec_shrmod(_1, _2, 2)`)),
    "MODPOW2C#": cat('div', mkfixedn(0xa93a, 16, 8, seq1(delta(1, uint(8))), `exec_shrmod(_1, _2, 2)`)),
    "RSHIFT#MOD": cat('div', mkfixedn(0xa93c, 16, 8, seq1(delta(1, uint(8))), `exec_shrmod(_1, _2, 2)`)),
    "RSHIFTR#MOD": cat('div', mkfixedn(0xa93d, 16, 8, seq1(delta(1, uint(8))), `exec_shrmod(_1, _2, 2)`)),
    "RSHIFTC#MOD": cat('div', mkfixedn(0xa93e, 16, 8, seq1(delta(1, uint(8))), `exec_shrmod(_1, _2, 2)`)),
    "MULADDRSHIFT#MOD": version(4, cat('div', mkfixedn(0xa9b0, 16, 8, seq1(delta(1, uint(8))), `exec_mulshrmod(_1, _2, 2)`))),
    "MULADDRSHIFTR#MOD": version(4, cat('div', mkfixedn(0xa9b1, 16, 8, seq1(delta(1, uint(8))), `exec_mulshrmod(_1, _2, 2)`))),
    "MULADDRSHIFTC#MOD": version(4, cat('div', mkfixedn(0xa9b2, 16, 8, seq1(delta(1, uint(8))), `exec_mulshrmod(_1, _2, 2)`))),
    "MULRSHIFT#": cat('div', mkfixedn(0xa9b4, 16, 8, seq1(delta(1, uint(8))), `exec_mulshrmod(_1, _2, 2)`)),
    "MULRSHIFTR#": cat('div', mkfixedn(0xa9b5, 16, 8, seq1(delta(1, uint(8))), `exec_mulshrmod(_1, _2, 2)`)),
    "MULRSHIFTC#": cat('div', mkfixedn(0xa9b6, 16, 8, seq1(delta(1, uint(8))), `exec_mulshrmod(_1, _2, 2)`)),
    "MULMODPOW2#": cat('div', mkfixedn(0xa9b8, 16, 8, seq1(delta(1, uint(8))), `exec_mulshrmod(_1, _2, 2)`)),
    "MULMODPOW2R#": cat('div', mkfixedn(0xa9b9, 16, 8, seq1(delta(1, uint(8))), `exec_mulshrmod(_1, _2, 2)`)),
    "MULMODPOW2C#": cat('div', mkfixedn(0xa9ba, 16, 8, seq1(delta(1, uint(8))), `exec_mulshrmod(_1, _2, 2)`)),
    "MULRSHIFT#MOD": cat('div', mkfixedn(0xa9bc, 16, 8, seq1(delta(1, uint(8))), `exec_mulshrmod(_1, _2, 2)`)),
    "MULRSHIFTR#MOD": cat('div', mkfixedn(0xa9bd, 16, 8, seq1(delta(1, uint(8))), `exec_mulshrmod(_1, _2, 2)`)),
    "MULRSHIFTC#MOD": cat('div', mkfixedn(0xa9be, 16, 8, seq1(delta(1, uint(8))), `exec_mulshrmod(_1, _2, 2)`)),
    "LSHIFT#ADDDIVMOD": version(4, cat('div', mkfixedn(0xa9d0, 16, 8, seq1(delta(1, uint(8))), `exec_shldivmod(_1, _2, 2)`))),
    "LSHIFT#ADDDIVMODR": version(4, cat('div', mkfixedn(0xa9d1, 16, 8, seq1(delta(1, uint(8))), `exec_shldivmod(_1, _2, 2)`))),
    "LSHIFT#ADDDIVMODC": version(4, cat('div', mkfixedn(0xa9d2, 16, 8, seq1(delta(1, uint(8))), `exec_shldivmod(_1, _2, 2)`))),
    "LSHIFT#DIV": cat('div', mkfixedn(0xa9d4, 16, 8, seq1(delta(1, uint(8))), `exec_shldivmod(_1, _2, 2)`)),
    "LSHIFT#DIVR": cat('div', mkfixedn(0xa9d5, 16, 8, seq1(delta(1, uint(8))), `exec_shldivmod(_1, _2, 2)`)),
    "LSHIFT#DIVC": cat('div', mkfixedn(0xa9d6, 16, 8, seq1(delta(1, uint(8))), `exec_shldivmod(_1, _2, 2)`)),
    "LSHIFT#MOD": cat('div', mkfixedn(0xa9d8, 16, 8, seq1(delta(1, uint(8))), `exec_shldivmod(_1, _2, 2)`)),
    "LSHIFT#MODR": cat('div', mkfixedn(0xa9d9, 16, 8, seq1(delta(1, uint(8))), `exec_shldivmod(_1, _2, 2)`)),
    "LSHIFT#MODC": cat('div', mkfixedn(0xa9da, 16, 8, seq1(delta(1, uint(8))), `exec_shldivmod(_1, _2, 2)`)),
    "LSHIFT#DIVMOD": cat('div', mkfixedn(0xa9dc, 16, 8, seq1(delta(1, uint(8))), `exec_shldivmod(_1, _2, 2)`)),
    "LSHIFT#DIVMODR": cat('div', mkfixedn(0xa9dd, 16, 8, seq1(delta(1, uint(8))), `exec_shldivmod(_1, _2, 2)`)),
    "LSHIFT#DIVMODC": cat('div', mkfixedn(0xa9de, 16, 8, seq1(delta(1, uint(8))), `exec_shldivmod(_1, _2, 2)`)),
    ...
    STI: cat('cell_serialize', mkfixedn(0xca, 8, 8, seq1(delta(1, uint(8))), `exec_store_int(_1, _2, true)`)),
    // STI: cat('cell_serialize', mkfixedn(0xcf08, 16, 8, seq1(delta(1, uint(8))), `exec_store_int_fixed`)),
    STU: cat('cell_serialize', mkfixedn(0xcb, 8, 8, seq1(delta(1, uint(8))), `exec_store_int(_1, _2, false)`)),
    // STU: cat('cell_serialize', mkfixedn(0xcf09, 16, 8, seq1(delta(1, uint(8))), `exec_store_int_fixed`)),
    LDI: cat('cell_deserialize', mkfixedn(0xd2, 8, 8, seq1(delta(1, uint(8))), `exec_load_int_fixed(_1, _2, 0)`)),
    // LDI: cat('cell_deserialize', mkfixedn(0xd708, 16, 8, seq1(delta(1, uint(8))), `exec_load_int_fixed2`)),
    LDU: cat('cell_deserialize', mkfixedn(0xd3, 8, 8, seq1(delta(1, uint(8))), `exec_load_int_fixed(_1, _2, 1)`)),
    ...
    LSHIFT: cat('shift_logic', mkfixedn(0xaa, 8, 8, seq1(delta(1, uint(8))), `exec_lshift_tinyint8(_1, _2, false)`)),
    QLSHIFT: cat('shift_logic', mksimple(0xb7ac, 16, `(_1) => exec_lshift(_1, true)`)),
    QLSHIFT: cat('shift_logic', mkfixedn(0xb7aa, 16, 8, seq1(delta(1, uint(8))), `exec_lshift_tinyint8(_1, _2, true)`)),
    BCHKBITS: cat('cell_serialize', mksimple(0xcf39, 16, `(_1) => exec_builder_chk_bits_refs(_1, 1)`)),
    BCHKBITS: cat('cell_serialize', mkfixedn(0xcf38, 16, 8, seq1(delta(1, uint(8))), `exec_builder_chk_bits(_1, _2, false)`)),
    BCHKBITSQ: cat('cell_serialize', mksimple(0xcf3d, 16, `(_1) => exec_builder_chk_bits_refs(_1, 5)`)),
    BCHKBITSQ: cat('cell_serialize', mkfixedn(0xcf3c, 16, 8, seq1(delta(1, uint(8))), `exec_builder_chk_bits(_1, _2, true)`)),
    ...
    RSHIFT: cat('shift_logic', mkfixedn(0xab, 8, 8, seq1(delta(1, uint(8))), `exec_rshift_tinyint8(_1, _2, false)`)),
    // RSHIFT: cat('div', mksimple(0xa924, 16, `exec_shrmod(_1, _2, 0)`)),
    QRSHIFT: cat('shift_logic', mksimple(0xb7ad, 16, `(_1) => exec_rshift(_1, true)`)),
    QRSHIFT: cat('shift_logic', mkfixedn(0xb7ab, 16, 8, seq1(delta(1, uint(8))), `exec_rshift_tinyint8(_1, _2, true)`)),
    // QRSHIFT: cat('div', mksimple(0xb7a924, 24, `exec_shrmod(_1, _2, 1)`)),
    ...
    THROW: cat('exception', mkfixedn(0xf20 >> 2, 10, 6, seq1(uint(6)), `exec_throw_fixed(_1, _2, 63, 0)`)),
    THROW: cat('exception', mkfixedn(0xf2c0 >> 3, 13, 11, seq1(uint(11)), `exec_throw_fixed(_1, _2, 0x7ff, 0)`)),
    THROWIF: cat('exception', mkfixedn(0xf24 >> 2, 10, 6, seq1(uint(6)), `exec_throw_fixed(_1, _2, 63, 3)`)),
    THROWIF: cat('exception', mkfixedn(0xf2d0 >> 3, 13, 11, seq1(uint(11)), `exec_throw_fixed(_1, _2, 0x7ff, 3)`)),
    THROWIFNOT: cat('exception', mkfixedn(0xf28 >> 2, 10, 6, seq1(uint(6)), `exec_throw_fixed(_1, _2, 63, 2)`)),
    THROWIFNOT: cat('exception', mkfixedn(0xf2e0 >> 3, 13, 11, seq1(uint(11)), `exec_throw_fixed(_1, _2, 0x7ff, 2)`)),
    ...
    DEBUG: cat('debug', mkfixedrangen(0xfe01, 0xfe14, 16, 8, seq1(uint(8)), `exec_dummy_debug`)),
    STRDUMP: cat('debug', mksimple(0xfe14, 16, `exec_dump_string`)),
    DEBUG: cat('debug', mkfixedrangen(0xfe15, 0xfe20, 16, 8, seq1(uint(8)), `exec_dummy_debug`)),
    DUMP: cat('debug', mkfixedn(0xfe2, 12, 4, seq1(stack(4)), `exec_dump_value`)),
    DEBUG: cat('debug', mkfixedrangen(0xfe30, 0xfef0, 16, 8, seq1(uint(8)), `exec_dummy_debug`)),
    ...
    // PUSH SHORT s*
    // PUSH LONG s*
    PUSH: cat('continuation_change', mkfixedrangen(0xed40, 0xed48, 16, 4, seq1(control), `exec_push_ctr`)),
    ...
    POP: cat('continuation_change', mkfixedrangen(0xed50, 0xed58, 16, 4, seq1(control), `exec_pop_ctr`)),
