...
async function Functions_init(opts?: { engine?: ExecutorEngine }) {
    const __init = 'te6ccgEBBgEAMAABFP8A9KQT9LzyyAsBAgFiAgMCAs4EBQAJoUrd4AUAAUgAGUcAHIzAEBgQEBzwDJg=';
    const __code = '';
    const __system = '';
...
export class Functions implements Contract {
    ...
    static async init(opts?: { engine?: ExecutorEngine }) {
        return await Functions_init(opts);
    }
    
    static async fromInit(opts?: { engine?: ExecutorEngine }) {
        const init = await Functions_init(opts);
