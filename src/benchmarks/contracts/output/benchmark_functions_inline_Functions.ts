...
async function Functions_init() {
    const __init = 'te6ccgEBBAEAJgABFP8A9KQT9LzyyAsBAgFiAgMAAtAAHaFK3OADkZgCAwICA54Bkw==';
    const __code = '';
    const __system = '';
    ...
    if (res.exitCode !== 0 && res.exitCode !== 1) {
        if (Functions_errors[res.exitCode]) {
            throw new ComputeError(Functions_errors[res.exitCode].message, res.exitCode, { logs: res.vmLogs });
        } else {
