...
- The typechecker now rejects integer map key types with variable width (`coins`, `varint16`, `varint32`, `varuint16`, `varuint32`): PR [#XXX](https://github.com/tact-lang/tact/pull/XXX)
