...
- The outdated TextMate-style grammar files for text editors have been removed (the most recent grammar files can be found in the [tact-sublime]() repo): PR [#404](https://github.com/tact-lang/tact/pull/404)
