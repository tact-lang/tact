...
- Tact does not anymore store the code of the parent contract in the system cell with all the child contract codes used in `initOf` to reduce gas fees: PR [#1212](https://github.com/tact-lang/tact/pull/1212)
