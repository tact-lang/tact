...
- Error messages in case when accessed field does not exist but there is a method with the same name now suggest using parentheses: PR [#622](https://github.com/tact-lang/tact/pull/622)
