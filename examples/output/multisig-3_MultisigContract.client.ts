...
async function MultisigContract_init(key1: bigint, key2: bigint, key3: bigint, opts?: { engine?: ExecutorEngine }) {
    const __init = 'te6ccgEBBgEANQABFP8A9KQT9LzyyAsBAgFiAgMCAs4EBQAJoUrd4AUAAUgAI0cATIzFUwUDTLH8v/y//L/8mA==';
    const __code = '';
    const __system = '';
...
export class MultisigContract implements Contract {
    ...
    static async init(key1: bigint, key2: bigint, key3: bigint, opts?: { engine?: ExecutorEngine }) {
        return await MultisigContract_init(key1, key2, key3, opts);
    }
    
    static async fromInit(key1: bigint, key2: bigint, key3: bigint, opts?: { engine?: ExecutorEngine }) {
        const init = await MultisigContract_init(key1, key2, key3, opts);
