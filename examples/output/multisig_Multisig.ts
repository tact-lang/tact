...
async function Multisig_init(members: Dictionary<Address, bigint>, totalWeight: bigint, requiredWeight: bigint) {
    const __init = 'te6ccgEBBAEAMQABFP8A9KQT9LzyyAsBAgFiAgMAAtAAM6FK3AeRmOADlAAGoEfoAQICA54BAgIDngGT';
