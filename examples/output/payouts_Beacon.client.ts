...
async function Beacon_init(master: Address, owner: Address, opts?: { engine?: ExecutorEngine }) {
    const __init = 'te6ccgEBBgEAMgABFP8A9KQT9LzyyAsBAgFiAgMCAs0EBQAJoUrd4AkAAdQAHdOAHkZgGtZ4ssZ4tlAGTA==';
    const __code = '';
    const __system = '';
...
export class Beacon implements Contract {
    ...
    static async init(master: Address, owner: Address, opts?: { engine?: ExecutorEngine }) {
        return await Beacon_init(master, owner, opts);
    }
    
    static async fromInit(master: Address, owner: Address, opts?: { engine?: ExecutorEngine }) {
        const init = await Beacon_init(master, owner, opts);
