...
description: "Supports highlighting Tact's syntax in JetBrains IDEs version **2023.** and later, and also provides rich support for the FunC and Fift languages of TON Blockchain, as well as TL-B schemas."
---
