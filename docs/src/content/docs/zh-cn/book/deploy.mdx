...
When you build your smart contracts using Tact, it produces a package (\*.pkg) file that has all the required information about the built smart contract. To deploy a smart contract in TON you need to send a message with `init` data attached to it.
