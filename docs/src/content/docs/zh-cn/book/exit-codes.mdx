...
| $4$        | [计算阶段][c]       | 整数溢出。 整数不适合<sup>-2256</sup>≤ x <<sup>2256</sup>或发生了零除法 |
| $5$        | [计算阶段][c]       | 整数超出预期范围                                               |
...
| $13$       | [计算阶段][c]       | 气体耗尽错误。 当剩余气体变为负值时，由 TVM 抛出                            |
| $-14$      | [计算阶段][c]       | 这意味着气体耗尽错误，与 $13$相同。 否定，因为无法伪造                         |
...
在 TVM 中，整数的范围可以是<sup>-2256</sup>< x <<sup>2256</sup>。
