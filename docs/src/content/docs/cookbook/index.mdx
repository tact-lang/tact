...
2. #### Multiple contracts {#multiple-contracts}
   ...
   For elaborate recipes that include smart contracts, auxiliary scripts, and testing suites, see the [Tact's DeFi Cookbook on GitHub](https://github.com/tact-lang/defi-cookbook).
