...
Note that TON Blockchain does not allow contracts to call each other's [getters](https://docs.tact-lang.org/book/contracts#getter-functions).  
To retrieve data from another contract, you must exchange messages.
