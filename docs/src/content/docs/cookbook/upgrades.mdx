...
:::danger
**Contract Upgrades Not Ready for Production Use**

The current upgrade feature is experimental and **not recommended for production** due to potential data storage inconsistencies when modifying contract layouts.

Using this feature in production may lead to unexpected behavior or data corruption.

A proper implementation is being developed - track progress here:
[https://github.com/tact-lang/tact/issues/27](https://github.com/tact-lang/tact/issues/27).
:::
