...
This page lists common examples of working with [Fungible Tokens (Jettons)](https://docs.ton.org/develop/dapps/asset-processing/jettons). That said, the [stablecoin contract](https://github.com/ton-blockchain/stablecoin-contract) is out of the scope of this page.
