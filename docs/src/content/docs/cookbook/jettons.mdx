...
:::tip
  ...
  Since Tact 1.6.6, primary and auxiliary structures for working with Jetton standards are available in the `@stdlib/jetton` library:

  ```tact
  // This would include everything from @stdlib/jetton
