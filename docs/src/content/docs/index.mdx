...
description: Tact is a new programming language for TON Blockchain focused on efficiency and simplicity. It is designed to be easy to learn and use, and to be a good fit for smart contracts.
template: splash
hero:
  tagline: Tact is a new programming language for TON Blockchain focused on efficiency and simplicity. It is designed to be easy to learn and use, and to be a good fit for smart contracts. Tact is a statically typed language with a simple syntax and a powerful type system.
  image:
   ...
   Check it out by moving into the relevant directory — `cd simple-counter/contracts{:shell}`. Here's what it would look like:
	 ...
	 contract SimpleCounter with Deployable {
	     ...
	     receive(msg: Add) {
	         ...
	         // and forward the remaining value back
...
1. #### Have some blockchain knowledge already? {#next-1}
   ...
   Alternatively, check the following cheat sheets to get started right away:
