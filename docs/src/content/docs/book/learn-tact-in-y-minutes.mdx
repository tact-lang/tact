...
try {
    ...
    //
    // See the "Test and debug" section below for more info.
}
...
// 3. can bounce
// 4. how to send them
// 5. the receiving part is in Contracts and traits.
```
...
contract MyContract(
    ...
    // which handles `null` (empty) message bodies of internal messages.
    receive() {
...
// TODO: more on exit codes
// TODO: something about gas usage.
```
