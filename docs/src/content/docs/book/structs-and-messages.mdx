...
:::caution
  ...
  **Warning**: Currently, circular types are **not** possible. This means that Struct/Message **A** can't have a field of Struct/Message **B** if Struct/Message **B** has a field of Struct/Message **A**.
