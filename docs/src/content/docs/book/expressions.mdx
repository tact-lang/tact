...
A [global function](/book/functions#fun-global) or a [member function](/book/functions#fun-member) of a [contract](/book/contracts) can be called from anywhere in the function body:
...
contract ExampleContract {
    receive() {
        ...
        expiration = self.answerQuestion(); // member function
    }
