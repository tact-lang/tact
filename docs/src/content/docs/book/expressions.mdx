...
You can also call [extension functions](/book/functions#extension-function) defined on certain [primitive types][p] corresponding to literals directly on the literal values:
