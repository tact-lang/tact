...
A [global function](/book/functions#fun-global) or a [internal function](/book/functions#fun-member) of a [contract](/book/contracts) can be called from anywhere in the function body:
