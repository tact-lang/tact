...
[Contracts](/book/contracts) in Tact serve as the main entry points for smart contracts on TON blockchain. They hold all [functions](/book/functions), [getters](/book/functions#getter-functions), and [receivers](/book/functions#receiver-functions) of a TON contract, and much more.
