...
:----------- | :---------------------- | :----------
`bounceable` | [`Bool{:tact}`][bool]   | Can the received message be [bounced back](https://docs.ton.org/v3/documentation/smart-contracts/message-management/non-bounceable-messages) or not.
