...
The `@stdlib/jetton` library provides primary and auxiliary structures and utilities for working with [Jetton standards](#sources). However, support of the [stablecoin contract and standard](https://github.com/ton-blockchain/stablecoin-contract) is out of the scope of this library.
...
:::note
  ...
  See how to apply this library in your contracts: [Common examples of working with Jettons in the Cookbook](/cookbook/jettons).

  Notice that support of the [stablecoin contract and standard](https://github.com/ton-blockchain/stablecoin-contract) is out of the scope of this library.
...
message(0xf8a7ea5) JettonTransfer {
    ...
    /// The amount of nanotons to be sent to the `responseDestination` address.
    forwardTonAmount: Int as coins;

    /// Optional custom data to be sent to the `responseDestination` address.
