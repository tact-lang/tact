...
3. #### Specification
   ...
   The [Specification](/ref/spec) page provides the full Tact grammar written in the Ohm language, which is used in Tact's compiler. It is aimed at more experienced programmers but generally can still be very handy for quickly grasping all possible syntax in the language.
