...
[Queues the `msg` message](/book/send#outbound-message-processing) to be sent by specifying the complete message cell.
The `mode` parameter configures how to send a message, see: https://docs.tact-lang.org/book/message-mode.
