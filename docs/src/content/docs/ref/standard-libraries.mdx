...
[`@stdlib/jetton-interface`][7]    | Structures for working with the [Jetton standard][jt].           | [`JettonMinterData{:tact}`][jmd], [`JettonWalletData(){:tact}`][jwd]
...
[7]: /ref/stdlib-jetton-interface
[jt]: /cookbook/jettons
[jmd]: /ref/stdlib-jetton-interface#jettonminterdata
[jwd]: /ref/stdlib-jetton-interface#jettonwalletdata
