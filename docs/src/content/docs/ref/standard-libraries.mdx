...
[`@stdlib/jetton`][7]    | Structures for working with the [Jetton standard][jt].           | [`JettonMinterData{:tact}`][jmd], [`JettonWalletData(){:tact}`][jwd]
...
[7]: /ref/stdlib-jetton
[jt]: /cookbook/jettons
[jmd]: /ref/stdlib-jetton#jettonminterdata
[jwd]: /ref/stdlib-jetton#jettonwalletdata
